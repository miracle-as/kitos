        ...
        public link(scope: IDirectiveScope, element: ng.IAugmentedJQuery, attrs: ng.IAttributes) {
            scope.mainGridOptions = {
                dataSource: {
                    ...
                    transport: {
                        read: {
                            url: () => `/odata/Users(${scope.userId})/ItSystemRights?$filter=Object/OrganizationId eq ${scope.currentOrganizationId}&$expand=Object($expand=ItSystem($select=Name)),Role($select=Name)`,
                            dataType: "json"
                        },
                    },
                    sort: {
