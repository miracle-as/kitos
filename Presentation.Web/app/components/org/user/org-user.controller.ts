    ...
    app.controller('org.UserCtrl', [
            ...
            function ($scope, $http, $state, $modal, $q, $stateParams, notify, user) {
                ...
                function isLocalAdmin(selectedUser) {
                    ...
                    return $http.get("api/OrganizationRight/?roleName=LocalAdmin&userId=" + uId + "&organizationId=" + oId + "&orgRightsForUserWithRole=").success(function (result) {
                ...
                function deleteOrgRoleAction(u) {
                    ...
                    $http.delete("api/OrganizationRight/?orgId=" + user.currentOrganizationId + "&userId=" + uId + "&byOrganization=").success(function (deleteResult) {
