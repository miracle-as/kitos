...
{
    public class LocalOptionExtendTypesController : LocalOptionBaseController<LocalOptionExtendType, ItContract, OptionExtendType, LocalOptionExtendTypeDTO, ItContractDTO, OptionDTO>
    {
